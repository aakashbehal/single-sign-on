...
const Activate = ({ location }: any) => {
    ...
    const activateUser = async (id: any, loginKey: any) => {
        const response: any = await axiosCustom.get(`${process.env.REACT_APP_BASE_URL_DOCUMENT_MANAGER}${process.env.REACT_APP_COMPLIANCE_SEARCH_URL}/activateme?id=${id}&loginKey=${loginKey}`)
