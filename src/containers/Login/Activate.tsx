...
const Activate = ({ location }: any) => {
    ...
    const activateUser = async (id: any, loginKey: any) => {
        const response: any = await axiosCustom.get(`${process.env.REACT_APP_BASE_URL_SSO}${process.env.REACT_APP_SSO_USER_SERVICE}/public/user/activateme?id=${id}&loginKey=${loginKey}`)
