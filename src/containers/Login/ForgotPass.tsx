...
const ForgotPassword = () => {
    ...
    const getSecurityQuestionBuUser = async (step: number) => {
        ...
        try {
            const response: any = await axiosCustom.post(`${process.env.REACT_APP_BASE_URL_SSO}${process.env.REACT_APP_SSO_USER_SERVICE}/public/user/getSecurityQuesByUserDetails`, reqObj)
            const data = handleResponse(response)
            setSq(data.response)
    ...
    const validateQuestions = async (step: number) => {
        ...
        try {
            const response: any = await axiosCustom.post(`${process.env.REACT_APP_BASE_URL_SSO}${process.env.REACT_APP_SSO_USER_SERVICE}/public/user/validateSecurityQuesByUserDetails`, reqObj)
            const data = handleResponse(response)
    ...
    const handleFinalSubmit = async (e: any) => {
        ...
        try {
            const response: any = await axiosCustom.post(`${process.env.REACT_APP_BASE_URL_SSO}${process.env.REACT_APP_SSO_USER_SERVICE}/public/user/resetPasswordByUserDetails`, reqObj)
            const data = handleResponse(response)
