...
const ForgotPassword = () => {
    ...
    const getOrganizationTypes = async () => {
        try {
            const response: any = await axiosCustom.get(`${process.env.REACT_APP_BASE_URL_DOCUMENT_MANANGER}${process.env.REACT_APP_COMMON_URL}/getLookUpListByGroupKeyVal/record_source`)
            const data = handleResponse(response)
    ...
    const getSecurityQuestionBuUser = async (step: number) => {
        ...
        try {
            const response: any = await axiosCustom.post(`${process.env.REACT_APP_BASE_URL_DOCUMENT_MANANGER}${process.env.REACT_APP_COMPLIANCE_SEARCH_URL}/getSecurityQuesByUserDetails`, reqObj)
            const data = handleResponse(response)
            setSq(data.response)
    ...
    const validateQuestions = async (step: number) => {
        ...
        try {
            const response: any = await axiosCustom.post(`${process.env.REACT_APP_BASE_URL_DOCUMENT_MANANGER}${process.env.REACT_APP_COMPLIANCE_SEARCH_URL}/validateSecurityQuesByUserDetails`, reqObj)
            const data = handleResponse(response)
    ...
    const handleFinalSubmit = async (e: any) => {
        ...
        try {
            const response: any = await axiosCustom.post(`${process.env.REACT_APP_BASE_URL_DOCUMENT_MANANGER}${process.env.REACT_APP_COMPLIANCE_SEARCH_URL}/resetPasswordByUserDetails`, reqObj)
            const data = handleResponse(response)
